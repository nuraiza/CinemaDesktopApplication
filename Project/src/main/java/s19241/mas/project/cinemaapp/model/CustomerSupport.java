...
public class CustomerSupport {
    ...
    private Set<@NonNull CustomerSupportRepresentative> employees = new HashSet<>();
    ...
    public void addEmployee(CustomerSupportRepresentative c) {
    ...
    public void removeEmployee(CustomerSupportRepresentative c) {
    ...
    public void AssignUserRequest() {
        for (CustomerSupportRepresentative e : this.employees) {
            if (e.getIsAvailable()) {
                e.takeRequest();
            }
        }
